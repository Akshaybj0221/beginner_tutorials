...
if("FALSE" STREQUAL "TRUE")
  ...
  set(beginner_tutorials_DEVEL_PREFIX /home/viki/catkin_ws/src/beginner_tutorials/build/devel)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'beginner_tutorials' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/usr/local/${idir}'.  Ask the maintainer 'viki <viki@todo.todo>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /usr/local/lib;/home/viki/catkin_ws/devel/lib;/opt/ros/kinetic/lib)
